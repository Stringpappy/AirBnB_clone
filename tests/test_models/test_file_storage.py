...
class test_storage(unittest.TestCase):
    """func that check the class """

    def setUp(self):
        """unittest to  check empty """
        try:
            remove('file.json')
        except Exception:
            pass
    ...
    def tearDown(self):
        """unittest to check remove class """
        try:
            remove('file.json')
        except Exception:
            pass
    ...
    def test_no_objs(self):
        """unittest to check empty class  """
        self.assertEqual(storage.all(), {})

    def test_all(self):
        """unittest to check  all function """
        storage = FileStorage()
        obj = storage.all()
